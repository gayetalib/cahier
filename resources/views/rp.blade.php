    ...
    <div class="admin">
      ...
      <nav class="admin__nav">
        <ul class="menu">
          ...
          <li class="menu__item" style="font-size: 30px">
            <a href="/rp-edt" class="menu__link">Consulter Absence</a>
          </li>
          <li class="menu__item" style="font-size: 30px">
            <a href="/enseignement" class="menu__link">Renseigner EDT</a>
          </li>
          <li class="menu__item" style="font-size: 30px">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form method='POST' action=''>
                     ...
                     <fieldset>
                                <legend style="text-align: center;font-weight:bold"><span style="color:RoyalBlue">Mes Classes</span></legend>
                         <div class="container">
                            <div class="row">
                                    <div class="col-sm-4">
                                    <button class="btn" style="background-color: RoyalBlue;color:white"><a href="/rp-absence" style="color: white">DIC1 Info</a></button>
                                    </div>
                                    <div class="col-sm-4">
                                    <button class="btn" style="background-color: RoyalBlue;color:white"><a href="/rp-absence" style="color: white">DIC2 TR</a></button>
                                    </div>
                                    <div class="col-sm-4">
                                    <button class="btn" style="background-color: RoyalBlue;color:white"><a href="/rp-absence" style="color: white">DUT1 INFO</a></button>
                                    </div>
                              </div> 
                         </div>
