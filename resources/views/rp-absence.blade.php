    ...
    <div class="admin">
      ...
      <nav class="admin__nav">
        ...
        <li class="menu__item" style="font-size: 30px">
          ...
          <li class="menu__item" style="font-size: 30px">
            <a href="/rp" class="menu__link">Consulter Absence</a>
          </li>
          <li class="menu__item" style="font-size: 30px">
            <a href="/rp-edt" class="menu__link">Renseigner EDT</a>
          </li>
          <li class="menu__item" style="font-size: 30px">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form method='POST' action=''>
                     ...
                     <fieldset>
                                <legend style="text-align: center;font-weight:bold">Nombre d'absence des étudiants</legend>
                      <div class="container">
                      <table>
  <tr>
    <th></th>
