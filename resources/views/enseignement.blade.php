                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form method='POST' action=''>
                     ...
                     <fieldset>
                                <legend style="text-align: center">Mes Enseignements</legend>
                      <div class="container">
                           <div class="row">
                                 <div class="col-sm-4">
                                 <button class="btn" style="background-color: RoyalBlue;color:white"><i class="fa fa-folder"></i><a href="/uml" style="color: white">UML</a></button>
                                 </div>
                                 <div class="col-sm-4">
                                 <button class="btn" style="background-color: RoyalBlue;color:white"><i class="fa fa-folder"></i><a href="/gl" style="color: white">Génie Logiciel</a></button>
                                 </div>
                                 <div class="col-sm-4">
                                 <button class="btn" style="background-color: RoyalBlue;color:white"><i class="fa fa-folder"></i><a href="/poo" style="color: white">POO</a></button>
                                 </div>
                           </div>
